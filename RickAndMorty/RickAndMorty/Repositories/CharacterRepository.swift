...
final class CharacterRepository {
    ...
    private let localDataSource: CharacterLocalDataSourceContract
    private let remoteDataSource: CharacterRemoteDataSourceContract
    
    init(localDataSource: CharacterLocalDataSourceContract = CharacterLocalDataSource(),
         remoteDatSource: CharacterRemoteDataSourceContract = CharacterRemoteDataSource()) {
...
extension CharacterRepository: CharacterRepositoryContract {
